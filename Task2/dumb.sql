...
(28, 'Acting BA (Hons)', 'Undergraduate', '3 years', 'Entering the Acting profession as a working stage and screen actor requires high-level skills and knowledge, which the Acting BA (Hons) degree at the University of Northampton is designed to help you develop.', 'Conservatoire-style teaching in dedicated specialist studios – view our Innovation Centre Studio Tour. High profile guests delivering world-class acting workshops throughout the year. One of 9 institutions in the world to have Estill Voice International Education Affiliation status. Links to prestigious Royal and Derngate theatre.', 'This Acting course has been designed to contribute towards achieving the following United Nations Sustainable Development Goals: SDG11: Sustainable Cities and Communities. All three years on Acting BA (Hons) degree have the core acting, vocal and movement pathways central to them.\r\n', 'A typical offer for BA Acting is: BBC at A-Level or, DDM at BTEC/Cambridge Technical or M at T Level in conjunction with an extensive audition. We welcome applications from a range of non-traditional education or professional qualifications, and from students with a mix of A levels and BTEC/Cambridge Technical qualifications.', 9250.00, 10500.00, 12000.00, 'How will I be taught on Acting BA (Hons)? - Classes are largely studio-based and practical in nature stretching you physically and personally whilst preparing you professionally. You will have over 30 hours of practical sessions per week. The acting industry is competitive and we aim to equip you for it by teaching you a wide range of skills. You will also work with inspiring and creative professional directors who are active in the industry.', 'https://www.northampton.ac.uk/wp-content/uploads/2022/08/student-drawing-artwork-768x512.jpg'),
